...
class PingProcessorTopologyTest {
    ...
    TestInputTopic<String, String> testGlobalInputTopic;
    ...
    void setup() {
        ...
        testGlobalInputTopic = testDriver.createInputTopic(kStreamsProcessorConfig.globalStores().topics().get("ping-data"),
                new StringSerializer(),
                new StringSerializer());
    }
    ...
    public void testKeyNotInStore() {
        ...
        assertThat(store.get("ID1"), equalTo(null));
    }

    @Test
    public void processKeyWithExistingValueInStore() {
        testGlobalInputTopic.pipeInput("ID1", "value1");
        sendAndTest("ID1", "whatever", "Stored value for ID1 is VALUE1");
