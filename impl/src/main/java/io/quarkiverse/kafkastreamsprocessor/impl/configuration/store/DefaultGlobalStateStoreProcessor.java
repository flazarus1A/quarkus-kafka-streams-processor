 ...
 *
 * @param <KIn> The type of the key for the input records.
 * @param <VIn> The type of the value for the input records.
 */
public class DefaultGlobalStateStoreProcessor<KIn, VIn> extends ContextualProcessor<KIn, VIn, Void, Void> {
     ...
     */
    private KeyValueStore<KIn, VIn> store;
